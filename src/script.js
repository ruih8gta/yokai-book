...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const yokaiData = [
        ...
        // 関東
        { name: 'イクチ', image: '', description: '茨城県の海に現れるという、うなぎのような長い妖怪。' },
        { name: '九尾の狐', image: '', description: '栃木県の那須野に現れたという、9本の尾を持つ狐の妖怪。' },
        { name: '天狗', image: '', description: '群馬県の山に住むという、神通力を持つ妖怪。' },
        { name: '夜道怪', image: '', description: '埼玉県に伝わる、一つ目の巨人。' },
        { name: '二口女', image: '', description: '千葉県に伝わる、後頭部に口を持つ女性の妖怪。' },
        { name: '一つ目小僧', image: 'img/hitotsume-kozo.png', description: '額に一つだけ目がある子供の姿の妖怪。' },
        { name: '舞首', image: '', description: '神奈川県の海に現れるという、3つの首だけの妖怪。' },
        // 中部
